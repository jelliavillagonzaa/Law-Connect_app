  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      case 'pending':
        ...
        body =
            'An administrator has not decided yet. You will use this email to complete registration once approved.';
        break;
      case 'approved':
        ...
        title = 'Approved';
        body =
            'You may create your password and sign in using “Complete registration”.';
        break;
      case 'rejected':
      ...
      case 'registered':
        ...
        body = 'Sign in with your staff email and password.';
        break;
      default:
