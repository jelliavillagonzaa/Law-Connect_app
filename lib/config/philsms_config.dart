...
class PhilSmsHearingAlertConfig {
  ...
  static String _fieldAsTrimmedString(dynamic value) {
  ...
  static bool isSmsEligibleHearing(Map<String, dynamic> data) {
    final caseNo = _fieldAsTrimmedString(data['caseNo']);
    if (caseNo.isEmpty) return false;
    final fullText = _fieldAsTrimmedString(data['fullText']);
    final summary = _fieldAsTrimmedString(data['summary']);
    final hearingDate = _fieldAsTrimmedString(data['hearingDate']);
